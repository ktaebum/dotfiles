    ...
    config = function()
      require("catppuccin").setup({
        ...
        custom_highlights = function(colors)
          return {
            ["@module"] = { fg = colors.rosewater, style = { "bold" } },
        ...
        highlight_overrides = {
          ...
          latte = function(colors)
            return {
              ...
              TelescopeSelection = { bg = colors.surface0 },
              TelescopeSelectionCaret = { fg = colors.sky, bg = colors.mantle },
              TelescopeMatching = { fg = colors.sky, bold = true },
              TelescopeTitle = { fg = colors.blue, bg = colors.mantle, bold = true },
              TelescopePromptTitle = { fg = colors.blue, bg = colors.mantle, bold = true },
              TelescopeResultsTitle = { fg = colors.blue, bg = colors.mantle, bold = true },
              TelescopePreviewTitle = { fg = colors.blue, bg = colors.mantle, bold = true },
            }
          end,
        },
      })
